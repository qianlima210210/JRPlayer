...
- (void)layoutSubviews{
    ...
    _sliderBtn.frame = CGRectMake(_finishPlayProgressView.frame.origin.x - kBtnWith / 2.0,
                                  (self.frame.size.height - kBtnWith)*0.5,
                                  kBtnWith,
                                  kBtnWith);
}
...
- (void)layoutSubviews{
    ...
    _iconImageView.frame = CGRectMake((self.frame.size.width - 17)*0.5,
